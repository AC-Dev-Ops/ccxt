...
class ImplicitAPI:
    ...
    private_get_account_fixed_loan_borrow_limit = privateGetAccountFixedLoanBorrowLimit = Entry('account/fixed-loan/borrowing-limit', 'private', 'GET', {'cost': 4})
    private_get_account_fixed_loan_borrow_order_list = privateGetAccountFixedLoanBorrowOrderList = Entry('account/fixed-loan/borrowing-orders-list', 'private', 'GET', {'cost': 4})
    private_get_account_fixed_loan_borrow_quote = privateGetAccountFixedLoanBorrowQuote = Entry('account/fixed-loan/borrowing-quote', 'private', 'GET', {'cost': 4})
    ...
    private_post_account_fixed_loan_convert_to_market_loan = privatePostAccountFixedLoanConvertToMarketLoan = Entry('account/fixed-loan/convert-to-market-loan', 'private', 'POST', {'cost': 4})
    private_post_account_fixed_loan_reduce_liabilities = privatePostAccountFixedLoanReduceLiabilities = Entry('account/fixed-loan/reduce-liabilities', 'private', 'POST', {'cost': 4})
